    ...
    <>
      <Section title="About" subtitle="Institutional excellence in pharmaceutical intelligence and transaction advisory." className="reduced-padding">
        <div style={{ display: 'grid', gap: 24, marginBottom: 24, width: '100%' }}>
          <div className="card" style={{ padding: 24, borderLeft: '4px solid #1e82c9', width: '100%' }}>
            <h3 style={{ color: '#1e82c9', marginBottom: 12, fontSize: '24px', fontWeight: 600 }}>Our Mission</h3>
          ...
          <div className="card" style={{ padding: 24, borderLeft: '4px solid #1e82c9', width: '100%' }}>
            <h3 style={{ color: '#1e82c9', marginBottom: 12, fontSize: '24px', fontWeight: 600 }}>Our Expertise</h3>
            <p style={{ lineHeight: 1.6, color: 'var(--color-text)', marginBottom: 16 }}>
          ...
          <div className="card" style={{ padding: 24, borderLeft: '4px solid #1e82c9', width: '100%' }}>
            <h3 style={{ color: '#1e82c9', marginBottom: 12, fontSize: '24px', fontWeight: 600 }}>Global Reach</h3>
        ...
        <div className="grid grid-2">
          <div className="card" style={{ padding: 18 }}>
            <h4 style={{ color: '#1e82c9', marginBottom: 8, fontSize: '20px', fontWeight: 600 }}>Mission</h4>
          ...
          <div className="card" style={{ padding: 18 }}>
            <h4 style={{ color: '#1e82c9', marginBottom: 8, fontSize: '20px', fontWeight: 600 }}>Vision</h4>
            <div className="muted">To become trusted bridge between global pharmaceutical opportunities and credible execution partners, enabling sustainable growth through strategic intelligence and confidential transactions.</div>
          </div>
        </div>
      </Section>
      <Section title="Strategic Advantages" subtitle="Our core strengths and positioning in the pharmaceutical ecosystem.">
        <div className="grid grid-3">
          <div className="panel">
            <div style={{ fontWeight: 700, marginBottom: 6 }}>Hyderabad Our Strategic Approach</div>
